...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/tagger/types v0.76.0-rc.3
	github.com/DataDog/datadog-agent/comp/forwarder/defaultforwarder v0.76.0-rc.3
	github.com/DataDog/datadog-agent/comp/logs/agent/config v0.76.0-rc.3
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/components/metricsclient v0.76.0-rc.3
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/testutil v0.76.0-rc.3
	...
	github.com/DataDog/datadog-agent/pkg/config/utils v0.76.0-rc.3
	...
	github.com/DataDog/datadog-agent/pkg/trace v0.76.0-rc.3
	...
	github.com/DataDog/datadog-agent/pkg/util/hostname/validate v0.76.0-rc.3
	github.com/DataDog/datadog-agent/pkg/util/option v0.76.0-rc.3
