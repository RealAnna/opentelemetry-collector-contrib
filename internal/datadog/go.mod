...
require (
	github.com/DataDog/datadog-agent/comp/otelcol/otlp/testutil v0.78.0-devel
	github.com/DataDog/datadog-agent/pkg/opentelemetry-mapping-go/inframetadata v0.77.0-devel.0.20260213154712-e02b9359151a
	github.com/DataDog/datadog-agent/pkg/opentelemetry-mapping-go/otlp/attributes v0.78.0-devel
