...
require (
	...
	github.com/DataDog/datadog-agent/pkg/util/hostname/validate v0.73.0-rc.5
	...
	go.opentelemetry.io/collector/config/configcompression v1.45.1-0.20251106125304-a6a176660925
